...
ols_plot_resid_stud(mFit4.0sna)
```
...
#| fig-width: 7
#| fig-height: 3
ols_plot_resid_stand(mFit4.0sna)
```
...
ols_plot_cooksd_chart(mFit4.0sna)
```
...
ols_plot_dffits(mFit4.0sna)
```

A Figura 8 acompanha os gráficos anteriores apresentando 6,9% de observações discrepantes.
